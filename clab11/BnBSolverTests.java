...
public class BnBSolverTests {
    ...
    public void simpleTest() {
        ...
        BnBSolver solver = new BnBSolver(bears, beds);
//        System.out.println(solver.solvedBears.size());
//        System.out.println(solver.solvedBeds.size());
        assertTrue(perfectMatch(solver.solvedBears(), solver.solvedBeds()));
    }
    ...
    public static void main(String[] args){
        BnBSolverTests test = new BnBSolverTests();
        test.simpleTest();
        test.reverseOrder();
        test.randomBearsAndBeds10();
        test.randomBearsAndBeds50();
        test.randomBearsAndBeds100();
        test.randomBearsAndBeds100x10();
    }
